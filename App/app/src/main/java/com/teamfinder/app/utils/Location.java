package com.teamfinder.app.utils;

public class Location {

    public final double latitude, longitude; // radians

    public Location newLocationDegrees(final double latitude, final double longitude) {
        return new Location(Math.toRadians(latitude), Math.toRadians(longitude));
    }

    public Location newLocationRadians(final double latitude, final double longitude) {
